...
Designed Microchip PIC18xxxx and Hi-Tech C.
Tested with PIC18F252.

Compiled with Hi-Tech C v8.12PL1.

Usage: #include in all ".c" files in project along with <pic18.h>
...
#define db asm("nop")		//convenient point for breakpoint (debugging)
