...
/*
//these lines work nicely - uncomment them to use
#if PIC_CLK == 4000000
...
#elif PIC_CLK == 8000000	#define dly125n please remove; for 32Mhz+ only
	#define dly250n please remove; for 16Mhz+ only
...
//delay routine
...
#if PIC_CLK == 3686400 || PIC_CLK == 4000000
	...
	#define DelayDivisor 1
	#define WaitFor1Us asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop");asm("nop")
	#define Jumpback asm("goto $ - 22")
#else
	#error delay.h - please define PIC_CLK correctly
#endif
